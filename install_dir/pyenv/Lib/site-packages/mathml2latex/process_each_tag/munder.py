...
def inspect_munder(child, insertion_list, index):
...
def process_munder(descendant, insertion_list):
    ...
    temp_list   = inspect_munder(child_list[0], insertion_list, index)
    base        = temp_list[0]
    index       += temp_list[1]

    temp_list   = inspect_munder(child_list[1], insertion_list, index)
