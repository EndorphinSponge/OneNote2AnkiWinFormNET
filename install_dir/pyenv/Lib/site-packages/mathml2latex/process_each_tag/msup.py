...
def inspect_msup(child, insertion_list, index):
...
def process_msup(descendant, insertion_list):
    ...
    temp_list   = inspect_msup(child_list[0], insertion_list, index)
    base        = temp_list[0]
    index       += temp_list[1]

    temp_list   = inspect_msup(child_list[1], insertion_list, index)
